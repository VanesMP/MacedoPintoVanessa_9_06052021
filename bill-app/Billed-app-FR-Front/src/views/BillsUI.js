...
//[Bug - Report]: affichage bills par ordre decroissant
//ajout de la méthode sort dans le return de la fonction rows pour trier le tableau des bills(par ordre décroissant et dans le bon format(new Date))
const rows = (data) => {
